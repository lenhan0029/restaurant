 ...
 * @author Shadow
 */
class SuggestMonAn extends JDialog{
    private String maSP;
    ...
    public SuggestMonAn(String maSP)
    {
        this.maSP = maSP;
        setModal(true);
        init();
...
/**************** TẠO CÁC BTN XÓA, SỬA, VIEW, IN BILL ********************/
        ...
        btnConfirm.setBounds(new Rectangle(100,330,150,45));
...
/*********************************************************************************/
    ...
    {
        if(spBUS.getList()== null)spBUS.listMA();
        ArrayList<MonAnDTO> nv = spBUS.getList();
        model.setRowCount(0);
        outModel(model,nv);
    }
