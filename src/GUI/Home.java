...
public class Home extends JFrame implements MouseListener{
    ...
    public void init()
    {
        ...
        ImageIcon logo = new ImageIcon("./src/image/headericon.png");
...
/************ PHẦN NAVIGATION ( MENU ) **************************/  
        nav = new JPanel(null);
        nav.setBackground(new Color(51, 153, 51));
...
//                main.add(new Page404(DEFALUT_WIDTH, "THỐNG KÊ - NHẬP HÀNG"));
                main.add(new PhieuNhapHangGUI(DEFALUT_WIDTH));
                main.repaint();
                main.revalidate();
            break;
            case 7: //NHÀ CUNG CẤP
    ...
    public void outNav()
    {
        ...
        {
            navObj.get(5).setColorNormal(new Color(204, 122, 0));
            navObj.get(6).setColorNormal(new Color(204, 122, 0));
        }
        
        //Xuất ra Naigation
        nav.removeAll();
        JLabel profile = new JLabel(new ImageIcon("./src/image/uicon.png"));
